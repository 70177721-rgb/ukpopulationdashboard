...
# Dashboard HTML is pre-built and embedded — no Excel file or subprocess needed.
# To regenerate, run uk_population_dashboard.py locally and redeploy.
...
<script>
const D = {"kpi": {"total_pop": 69281437, "male_pop": 33930768, "female_pop": 35350669, "yoy_growth": 1.1, "median_age": 40.5, "births": 662148, "deaths": 645909, "intl_net_mig": 738718, "pop_2023": 68526183, "pop_2011": 63285145, "largest_la": "Birmingham", "largest_la_pop": 1183618}, "age_pyramid": {"bands": ["0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59", "60-64", "65-69", "70-74", "75-79", "80-84", "85-89", "90+"], "female": [1744355, 1941658, 2052052, 2002835, 2034609, 2291610, 2463301, 2472291, 2333109, 2088285, 2255231, 2360202, 2193915, 1838574, 1622996, 1551183, 1024480, 665267, 414716], "male": [1829801, 2037199, 2152800, 2123750, 2131646, 2257360, 2333326, 2303479, 2196013, 2005099, 2164862, 2256521, 2094462, 1734083, 1473758, 1350668, 815910, 459511, 210520]}, "age_groups": {"labels": ["0 to 4", "5 to 9", "10 to 14", "15 to 19", "20 to 24", "25 to 29", "30 to 34", "35 to 39", "40 to 44", "45 to 49", "50 to 54", "55 to 59", "60 to 64", "65 to 69", "70 to 74", "75 to 79", "80 to 84", "85 to 89"], "values": [3574156, 3978857, 4204852, 4126585, 4166255, 4548970, 4796627, 4775770, 4529122, 4093384, 4420093, 4616723, 4288377, 3572657, 3096754, 2901851, 1840390, 1124778]}, "uk_trend": {"years": [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024], "values": [63285145, 63710543, 64138221, 64618693, 65086958, 65605841, 65964292, 66286727, 66627507, 66739867, 66977988, 67636134, 68526183, 69281437]}, "nations_trend": {"years": [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024], "series": {"England": [53107169, 53506812, 53918686, 54370319, 54808676, 55289034, 55619548, 55924528, 56230056, 56325961, 56554891, 57144395, 57932470, 58620101], "Wales": [3063758, 3070928, 3071058, 3073788, 3072739, 3077165, 3081366, 3083840, 3087732, 3104483, 3105633, 3134196, 3167331, 3186581], "Scotland": [5299900, 5308200, 5316800, 5331400, 5350600, 5373600, 5388200, 5392100, 5411200, 5408900, 5412900, 5447000, 5506000, 5546900], "N. Ireland": [1814318, 1824603, 1831677, 1843186, 1854943, 1866042, 1875178, 1886259, 1898519, 1900523, 1904564, 1910543, 1920382, 1927855]}}, "top10_la": {"names": ["Birmingham", "Leeds", "Glasgow City", "North Yorkshire", "Manchester", "Somerset", "Cornwall", "Sheffield", "Buckinghamshire", "Bradford"], "values": [1183618, 845189, 650300, 635270, 589670, 588328, 583289, 582493, 578772, 563605]}, "regions": {"names": ["South East", "London", "North West", "East", "West Midlands", "South West", "Yorkshire And The Humber", "East Midlands", "North East"], "values": [9642942, 9089736, 7737414, 6576306, 6187204, 5889695, 5672962, 5063164, 2760678]}, "countries": {"names": ["England", "Wales", "Scotland", "N. Ireland"], "values": [58620101, 3186581, 5546900, 1927855]}, "migration": {"nat_names": ["England", "Wales", "Scotland", "N. Ireland"], "births": [568537, 27475, 46351, 19785], "deaths": [530443, 35587, 62024, 17855], "intl_net": [667467, 22680, 42600, 5971]}, "median_age_trend": {"years": [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024], "values": [39.6, 39.8, 39.9, 40.0, 40.1, 40.1, 40.2, 40.2, 40.4, 40.6, 40.8, 40.7, 40.6, 40.5]}, "oldest_la": {"names": ["North Norfolk", "East Lindsey", "Rother", "Derbyshire Dales", "West Devon", "Torridge", "New Forest", "Dorset", "Isle of Wight", "Fylde"], "values": [56.0, 54.1, 53.7, 53.2, 52.7, 52.5, 52.4, 52.2, 52.1, 51.9]}, "youngest_la": {"names": ["Manchester", "Tower Hamlets", "Nottingham", "Newham", "Cambridge", "Oxford", "Hackney", "Leicester", "Islington", "Barking and Dagenham"], "values": [30.4, 30.6, 31.3, 31.4, 31.5, 31.8, 32.6, 32.9, 32.9, 32.9]}, "regions_median_age": {"names": ["London", "West Midlands", "North West", "Yorkshire And The Humber", "East Midlands", "East", "North East", "South East", "South West"], "values": [35.7, 39.8, 40.0, 40.3, 41.3, 41.6, 41.8, 41.8, 43.7]}};
...
@app.route("/health")
def health():
    return {"status": "ok", "size_kb": len(DASHBOARD_HTML) // 1024}, 200
